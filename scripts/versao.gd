...
const NUMERO := 74
const DATA := "23/09/2026"
const NOTA := "jogo desenhado em pé (letras nítidas), lutador com capacete e jogo de pernas, nocaute final fica na lona, comemora com a torcida, pontuação mais difícil"
